        ...
        {user.isLogged ? (
          ...
          <div className="relative flex justify-center items-center">
            <Link
              ...
              to={"/Login"}
            >
              <button className=" h-full shadow-[0_0_30px_rgba(0,0,0,0.3)] w-full bg-main text-buttonText tracking-wider mx-auto block rounded-lg transition-colors hover:bg-mainHover outline-4 outline outline-whiteHover">
                გაიარე ავტორიზაცია
              </button>
            </Link>
