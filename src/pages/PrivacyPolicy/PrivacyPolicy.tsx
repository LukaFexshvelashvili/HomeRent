  ...
  return (
    <main>
      <div className="text-Asmall text-textInfo">
        ...
        <p>
          როგორც ნებისმიერი სხვა ვებგვერდი, onhome.ge იყენებს 'Cookie-ფაილებს'.
          ეს Cookie-ფაილები გამოიყენება ინფორმაციის შესანახად, მათ შორის
          ვიზიტორების პრეფერენციებისა და ვებგვერდის გვერდების, რომლებიც
          ვიზიტორმა მოინახულა ან ეწვია. ინფორმაცია გამოიყენება მომხმარებელთა
          გამოცდილების ოპტიმიზაციისთვის ჩვენი ვებ გვერდის შინაარსის მორგებით
          ვიზიტორების ბრაუზერის ტიპისა და/ან სხვა ინფორმაციის საფუძველზე.
        </p>
        <h2>Google DoubleClick DART Cookie</h2>
        <p>
          Google არის ჩვენი საიტის ერთ-ერთი მესამე მხარის გამყიდველი. ის ასევე
          იყენებს Cookie-ფაილებს, რომლებიც ცნობილია როგორც DART Cookie-ფაილები,
          რომ მოემსახუროს რეკლამებს ჩვენს საიტზე ვიზიტორებისათვის მათი ვიზიტების
          საფუძველზე www.website.com-ზე და სხვა საიტებზე ინტერნეტში. თუმცა,
          ვიზიტორებს შეუძლიათ უარი თქვან DART Cookie-ფაილების გამოყენებაზე
          Google რეკლამებისა და კონტენტ ქსელის კონფიდენციალურობის პოლიტიკის
          URL-ზე -
